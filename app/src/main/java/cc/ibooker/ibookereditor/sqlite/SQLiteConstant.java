...
public class SQLiteConstant {
    ...
    // 创建用户表
    static final String SQL_CREATE_TABLE_USER = "CREATE TABLE IF NOT EXISTS t_user(_id INTEGER PRIMARY KEY autoincrement,u_id BIGINT NOT NULL UNIQUE,u_phone BIGINT NOT NULL UNIQUE,u_pic VARCHAR(100) NOT NULL,u_nickname VARCHAR(15) NOT NULL,u_introduce VARCHAR(500),u_ua VARCHAR(500) NOT NULL,u_token VARCHAR(500) NOT NULL)";
    // 删除用户表
